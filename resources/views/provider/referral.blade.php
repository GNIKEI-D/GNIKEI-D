                            ...
                            <form>
                                ...
                                <div class="form-row clearfix">
                                    <div class="form-group col-md-4">
                                        ...
                                        <a id="invite" href="mailto:testmail?subject=Conheça o {{config('constants.site_title','TAXI3')}}&body=Hi,%0A%0A I found this website and thought you might like it. Use my referral code({{\Auth::guard('provider')->user()->referral_unique_id}}) on registering in the application.%0A%0AWebsite: {{url('/')}}/provider/login %0AReferral Code: {{\Auth::guard('provider')->user()->referral_unique_id}}" class="btn btn-invite">Invite</a> 
                                    </div>
                                </div>
                            </form>
