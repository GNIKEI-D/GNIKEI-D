        ...
        <div class="card">
            ...
            <form class="form-horizontal" action="{{route('admin.transferstore')}}" method="POST" enctype="multipart/form-data" role="form" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-5">
                        <div class="input-group">
                            <input class="form-control" type="text" value="{{ old('name') }}" name="name" required id="namesearch" placehold="Name" required="" aria-describedby="basic-addon2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control" type="text" value="{{ old('amount') }}" name="amount" id="amount" placehold="Amount" required="" min="1">
                    </div>
                    <div class="col-xs-5">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-5">
                        <select class="form-control" name="send_by">
                            ...
                            <option value="online">Gasuli</option>
                        </select>
                    </div>
                </div>
