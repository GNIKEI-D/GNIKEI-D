            ...
            <div class="card-body">
                <div class="col-md-12">
                    <div id="floating-panel">
                        <button class="btn btn-primary" onclick="toggleHeatmap(event)">ჩართვა / გამორთვა</button>
                        <button class="btn" onclick="changeGradient(event)">ფერის შეცვლა</button>
                        <button class="btn btn-primary" onclick="changeRadius(event)">რადიუსის ცვლილება</button>
                        <button class="btn btn-primary" onclick="changeOpacity(event)">გამჭირვალობა</button>
                    </div> <br>
