    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header card-header-primary">
                ...
                <h5>მძღოლი: <b>{{ $Provider->first_name }} {{ $Provider->last_name }}</b> </h5>
                @can('provider-status')
                ...
                <a style="margin-left: 1em;margin-top: -30px" class="btn btn-success pull-right"
                    href="{{ route('admin.provider.approve', $Provider->id ) }}"><i class="fa fa-check"></i> გააქტიურე
                    მძღოლი</a>
                @endcan
                @endif
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            @can('provider-service-update')<button class="btn btn-primary btn-block"
                                type="submit">განახლება</button>@endcan
                        </div>
                        </div>
                    </div>
                    @endif
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                @can('provider-service-update')<button class="btn btn-success"
                                    type="submit">დამატება</button>@endcan
                            </div>
                            </div>
                        </div>
                        @endif
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>@if($Document->status == "ACTIVE"){{ "APPROVED" }}@else {{ " ელოდება დასტურს" }}
                                    @endif</td>
                                <td>
