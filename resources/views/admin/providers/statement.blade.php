    ...
    <div class="card">
        ...
        <div class="row">
            <div class="col">
                    ...
                    <p>სახელი: <b>{{$Provider->first_name}} {{$Provider->last_name}}</b></p>
                    <p>ტელეფონი: <b>{{$Provider->mobile}}</b></p>
                    <p>ელ-ფოსტა: <b>{{$Provider->email}}</b></p>
                    @endif
                </div>
                <div class="col">
                ...
                <div class="col-lg-4 col-md-6 col-xs-12">
                    <div class="box box-block bg-white tile tile-1 mb-2" style="border-top-color: #4bcb73 !important;">
                        ...
                        <div class="t-content">
                            ...
                            <i class="fa fa-caret-up text-success mr-0-5"></i><span>{{$pagination->total}}
                                წარმატებულია</span>
                        </div>
                    </div>
                </div>
