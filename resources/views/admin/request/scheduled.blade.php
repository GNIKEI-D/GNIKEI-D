        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header card-header-primary">
                    <h5 class="card-title ">Javshnebi</h5>
                  </div>
                  <div class="card-body">
                @if(count($requests) != 0)
                    ...
                    @foreach($requests as $index => $request)
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="tag tag-success">AQTIURI</span>
                                @elseif($request->status == "CANCELLED")
                                <span class="tag tag-danger">GAUQMEBULI</span>
                                @else
                            ...
                            <td>
                                <div class="input-group-btn">
                                  ...
                                  <ul class="dropdown-menu">
                                    <li>
                                        <a href="{{ route('admin.requests.show', $request->id) }}" class="btn btn-default"><i class="fa fa-search"></i> DETALURAD</a>
                                    </li>
                                  </ul>
                                </div>
                            </td>
