...
<div>
    <div class="container-fluid">
            ...
            <nav class="navbar navbar-light bg-white b-a mb-2">
                ...
                <div class="collapse navbar-toggleable-sm" id="process-filters">
                    <ul class="nav navbar-nav dispatcher-nav">
                        <li class="nav-item"><span class="nav-link" href="#">იძებნება</span></li>
                        <li class="nav-item active"><span class="nav-link" href="#">გაუქმდა</span></li>
        ...
        <div class="dispatch-content row">
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header text-uppercase"><b>გაუქმების სია</b></div>
                            ...
                            <a class="text-black" href="#">
                                <div class="media">
                                    <div class="media-body">
                                        <p class="mb-0-5">
                                        	Paul Wesley
                                            <span class="tag tag-danger pull-right">გაუქმებულია</span>
                                       	</p>
