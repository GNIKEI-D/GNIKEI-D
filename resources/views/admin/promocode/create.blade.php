...
@section('title', 'პრომო კოდის დამატება ')
...
<link rel="stylesheet" type="text/css" href="{{asset('asset/css/bootstrap-datetimepicker.min.css')}}">
    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <p style="color: #cc0033;"><b>შენიშვნა:</b> თითო მომხმარებელს შეეძლება გამოიყენოს 1ხელ ვადის ამოწურვამდე. </p><br>
            ...
            <form class="form-horizontal" action="{{route('admin.promocode.store')}}" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-10">
                        <textarea id="promo_description" placehold="Description" class="form-control" name="promo_description">0% off, მაქსიმალური ფასდაკლება 0{{old('promo_description')}}</textarea>
                    </div>
                </div>
