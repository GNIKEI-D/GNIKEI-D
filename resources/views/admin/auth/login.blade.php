            ...
            <div class="col-lg-8 col-lg-offset-2 col-md-6 col-md-offset-3 col-md-8 col-md-offset-2">
                ...
                <div id="userform">
                    <ul class="nav nav-tabs nav-justified" role="tablist">
                        <li id="last-button" @if (!$errors->has('login_type')) class="active" @endif @if ($errors->has('login_type') && $errors->first('login_type') == 'admin')  class="active" @endif><a href="#signup" role="tab" data-toggle="tab">ადმინისტრატორი</a></li>
                        <li @if ($errors->has('login_type') && $errors->first('login_type') == 'dispatcher')  class="active" @endif><a href="#dispatcher" role="tab" data-toggle="tab">დისპეჩერი</a></li>
                        <li @if ($errors->has('login_type') && $errors->first('login_type') == 'account')  class="active" @endif><a href="#account" role="tab" data-toggle="tab">ანგარიშების მენეჯერი</a></li>
                        <li id="first-button" @if ($errors->has('login_type') && $errors->first('login_type') == 'dispute')  class="active" @endif><a href="#dispute" role="tab" data-toggle="tab">საჩივრების მენეჯერი</a></li>
                    </ul>
