				...
				<div class="form-group">
					...
					<div class="col-xs-10">
						<select class="form-control" name="type" id="type">
							<option value="USER" @if($reason->type=='USER')selected @endif>მომხმარებელი</option>
							<option value="PROVIDER" @if($reason->type=='PROVIDER')selected @endif>მძღოლი</option>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-xs-10">
						<select class="form-control" name="status" id="status">
							<option value="1" @if($reason->status==1)selected @endif>აქტიური</option>
							<option value="0" @if($reason->status==0)selected @endif>არა აქტიური</option>
						</select>
					</div>
				</div>
