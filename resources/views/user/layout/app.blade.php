        ...
        <div id="wrapper">
             ...
             <nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
                <ul class="nav sidebar-nav">
                    ...
                    <li class="full-white">
                        <a href="{{ url('/register') }}">მგზავრობა</a>
                    </li>
                    <li class="white-border">
                        <a href="{{ url('/provider/register') }}">გახდი მძღოლი</a>
                    </li>
                    <li>
                        <a href="{{ url('/ride') }}">მგზავრი</a>
                    </li>
                    <li>
                        <a href="{{ url('/drive') }}">მძღოლი</a>
                    </li>
                    <li>
                        <a href="{{ url('help') }}">დახმარება</a>
                    </li>
                    <li>
                        <a href="{{ url('privacy') }}">კონფიდენციალურობის პოლიტიკა</a>
                    </li>
                    <li>
                        <a href="{{ url('terms') }}">წესები</a>
                    </li>
                    <li>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                ...
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li><a class="btn-outline" href="{{url('/register')}}">დარეგისტრირდი მგზავრობისთვის</a></li>
                                    <li><a class="menu-btn" href="{{url('/provider/register')}}">დარეგისტრირდი მძღოლად</a></li>
                                </ul>
                            </div>
                        </div>
                    </nav>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12  col-md-6 sup-txt"><h2>გაკვთ კითხვები?     დაგვირეკეთ</h2>
                                <div class="call-num">
                                    <h3 class=""><a href="mailto:{{ config('constants.contact_email', 'Support@taxi3.ge')  }}">
                                    <span class="phone-icon"><i class="fa fa-3x fa-envelope"></i></span>
                                    {{ config('constants.contact_email', 'info@taxi3.ge')}}</a> </h3>
                                </div>
                            </div>
                            <div class="hidden-xs hidden-sm col-md-2 support">
                              ...
                              <div class="col-md-12">
                                <div class="call-num">
                <h3 class=""><a href="tel:{{ Setting::get('contact_number', '')  }}"><span class="phone-icon"><i class="fa fa-3x fa-phone"></i></span> {{ Setting::get('contact_number', '+995
                ')  }}</a> </h3>
                                </div>
                    ...
                    <div class="footer row no-margin">
                        <div class="container-fluid">
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="col-md-6">
                                                        <a target="_blank" href="{{config('constants.store_link_ios_user','#')}}">
                                                            <img src="{{asset('asset/img/user-appstoree.png')}}">
                                                        </a>
                                                    </div>
                                                    @endif
                            ...
                            <div class="row no-margin">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-12">
                                    <ul>
                                        <li><a href="{{url('ride')}}">დარეგისტრირდი რომ იმგზავრო</a></li>
                                        <li><a href="{{url('drive')}}">გახდი მძღოლი</a></li>
                                        <li><a href="{{url('ride')}}">მგზავრობა</a></li>                            
                                    </ul>
                                </div>
                            ...
                            <div class="row no-margin">
                                <div class="col-md-12 copy">
                                    <p>{{ config('constants.site_copyright', '&copy; '.date('Y').' TAXI3') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>{{ config('constants.site_title','TAXI3') }} </p>
                    </div>
