    ...
    <div class="full-page-bg-inner">
        <div class="row no-margin">
            <div class="col-md-6 log-left">
                ...
                <p>დარეგისტრირდი {{config('constants.site_title','TAXI3')}},.</p>
            </div>
            <div class="col-md-6 log-right">
                <div class="login-box-outer">
                    <div class="login-box row no-margin">
                        <div class="col-md-12">
                            <a class="log-blk-btn" href="{{url('login')}}">რეგისტრაცია?</a>
                            <h3>რეგისტრაცია</h3>
                        </div>
...
<!--                            <div id="first_step">
                                ...
                                <div class="col-md-8">
                                    <input type="text" autofocus id="phone_number" class="form-control" placehold="ნომერი" name="phone_number" value="{{ old('phone_number') }}" data-stripe="number" maxlength="11" onkeypress="return isNumberKey(event);" required/>
                                </div>
                            ...
                            <div id="second_step">
                                ...
                                <div class="col-md-6">
                                    <input type="text" autofocus class="form-control" placehold="სახელი" name="first_name" value="{{ old('first_name') }}" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="სახელი უნდა შეიცავდეს მხოლოდ - ასოებს.">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" placehold="გვარი" name="last_name" value="{{ old('last_name') }}" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="გვარი უნდა შეიცავდეს მხოლოდ - ასოებს">
                                ...
                                <div class="col-md-12">
                                    <input type="email" class="form-control" name="email" placehold="ელ-ფოსტა" value="{{ old('email') }}" data-validation="email">
                                ...
                                <div class="col-md-12">
                                    <input type="text" id="phone_number" class="form_tel" class="form-control" placehold="ნომერი" name="phone_number" value="{{ old('phone_number') }}" data-stripe="number" maxlength="11" onkeypress="return isNumberKey(event);" required/>
                                </div>
                        ...
                        <div class="col-md-12">
                            <p class="helper"><a href="{{route('login')}}">შესვლა</a>.</p>   
                        </div>

                    </div>


                    <div class="log-copy"><p class="no-margin">{{ config('constants.site_copyright', '&copy; '.date('Y').' TAXI3') }}</p></div>
                </div>
            </div>
        </div>
    </div>
