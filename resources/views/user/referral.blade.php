                    ...
                    <form>
                        ...
                        <div class="form-row clearfix">
                            <div class="form-group col-md-4">
                                ...
                                <a id="invite" href="mailto:testmail?subject=Convido você se juntar ao {{config('constants.site_title','TAXI3')}}&body=Hi,%0A%0A Eu participo deste site e achei que você poderia gostar. Use meu código de referência({{\Auth::user()->referral_unique_id}}) e faça seu cadastro.%0A%0A Site: {{url('/')}}/provider/login %0A Código Referência: {{\Auth::user()->referral_unique_id}}" class="btn btn-invite">Convidar</a> 
                            </div>
                        </div>
                    </form>
