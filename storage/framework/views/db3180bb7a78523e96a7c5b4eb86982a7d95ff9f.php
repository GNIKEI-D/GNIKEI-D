<?php $__env->startSection('title', 'გადახდის პარამეტრები'); ?>
                        ...
                        <ul class="nav nav-tabs" data-tabs="tabs">
                            <li class="nav-item">
                                <a class="nav-link active" id="paymentMode-tab" data-toggle="tab" href="#paymentMode"
                                    role="tab" aria-controls="paymentMode" aria-expanded="true">გადახდის რეჟიმი</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " id="paymentSetting-tab" data-toggle="tab" href="#paymentSetting"
                                    role="tab" aria-controls="paymentSetting" aria-expanded="false">გადახდის პარამეტრები</a>
                            </li>
                                                            ...
                                                            <div class="col-xs-8">
                                                                <select name="stripe_currency" class="form-control"
                                                                    ...
                                                                    <option
                                                                        ...
                                                                        selected <?php endif; ?> value="BRL">GEL</option>
                                                                    <option
                                                                        <?php if(config('constants.stripe_currency')=="GEL" ): ?>
                                                                        selected <?php endif; ?> value="BRL">GEL</option>
                                                                    <option
                                                                        <?php if(config('constants.stripe_currency')=="GEL" ): ?>
                                                                        selected <?php endif; ?> value="USD">GEL</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
