    ...
    <div class="card">
        ...
        <div class="row">
            <div class="col">
                    ...
                    <p>სახელი: <b><?php echo e($Provider->first_name); ?> <?php echo e($Provider->last_name); ?></b></p>
                    <p>ტელეფონი: <b><?php echo e($Provider->mobile); ?></b></p>
                    <p>ელ-ფოსტა: <b><?php echo e($Provider->email); ?></b></p>
                    <?php endif; ?>
                </div>
                <div class="col">
            ...
            <div class="nav-tabs-navigation">
                <div class="nav-tabs-wrapper">
                    <ul class="nav nav-tabs" data-tabs="tabs">
                            <li class="nav-item">
                    <a style="cursor:pointer" id="tday" class="nav-link showdate">დღეს</a>
                    </li>
                    <li class="nav-item">
                    <a style="cursor:pointer" id="yday" class="nav-link showdate">გუშინ</a>
                </li>
                <li class="nav-item">
                    <a style="cursor:pointer" id="cweek" class="nav-link showdate">ამ კვირაში</a>
                </li>
                <li class="nav-item">
                    <a style="cursor:pointer" id="pweek" class="nav-link showdate">წინა კვირაში</a>
                </li>
                <li class="nav-item">
                    <a style="cursor:pointer" id="cmonth" class="nav-link showdate">ამ თვეში</a>
                </li>
                <li class="nav-item">
                    <a style="cursor:pointer" id="pmonth" class="nav-link showdate">Last month</a>
                </li>
                <li class="nav-item">
                    <a style="cursor:pointer" id="cyear" class="nav-link showdate">წელს</a>
                </li>
                <li class="nav-item">
                    <a style="cursor:pointer" id="pyear" class="nav-link showdate">წინა წელს</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="clearfix" style="margin-top: 15px;">
                ...
                <form class="form-horizontal" action="<?php echo e(route('admin.ride.statement.range')); ?>" method="GET"
                    ...
                    <div class="form-group col-md-3">
                        <label for="name" class="col-xs-1 col-form-label">საიდან</label>
                        <div class="col-xs-8">
                            <?php if(isset($statement_for) && $statement_for =="provider"): ?>
                    ...
                    <div class="form-group col-md-3">
                        <label for="email" class="col-xs-1 col-form-label">სად</label>
                        <div class="col-xs-8">
                    ...
                    <div class="form-group col-md-3">
                        <label for="email" class="col-xs-4 col-form-label">სტატუსი</label>
                        <div class="col-xs-8">
                            <select class="form-control" name="payment_status">
                                <option value="all">აირჩიე</option>
                                <option value="paid">გადახდილია</option>
                                <option value="not_paid">არ არის გადახდილი</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        <div class="col-xs-8">
                            <select class="form-control" name="payment_mode">
                                ...
                                <option value="debit_machine">სხვა</option>
                                <option value="voucher">პრომო კოდი</option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-xs-12">
                    <div class="box box-block bg-white tile tile-1 mb-2" style="border-top-color: #3e70c9 !important;">
                        ...
                        <div class="t-content">
                            ...
                            <i class="fa fa-caret-up text-success mr-0-5"></i><span>წარმატებულია</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-xs-12">
                    <div class="box box-block bg-white tile tile-1 mb-2" style="border-top-color: #4bcb73 !important;">
                        ...
                        <div class="t-content">
                            ...
                            <i class="fa fa-caret-up text-success mr-0-5"></i><span><?php echo e($pagination->total); ?>
                ...
                <div class="col-lg-4 col-md-6 col-xs-12">
                    <div class="box box-block bg-white tile tile-1 mb-2" style="border-top-color: #f44236 !important;">
                        ...
                        <div class="t-content">
                            ...
                            <i class="fa fa-caret-down text-danger mr-0-5"></i><span>გაუქმებულია</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="box bg-white">
                            ...
                            <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="tag tag-success">დასრულებულია</span>
                                                <?php elseif($ride->status == "CANCELLED"): ?>
                                                <span class="tag tag-danger">გაუქმებულია</span>
                                                <?php else: ?>
                                            ...
                                            <td>
                                                <a class="text-primary"
                                                    href="<?php echo e(route('admin.requests.show',$ride->id)); ?>"><span
                                                        class="underline">დეტალები</span></a>
                                            </td>
                                        </tr>
                                ...
                                <?php else: ?>
                                <h6 class="no-result">შედეგები ვერ მოიძებნა</h6>
                                <?php endif; ?>
