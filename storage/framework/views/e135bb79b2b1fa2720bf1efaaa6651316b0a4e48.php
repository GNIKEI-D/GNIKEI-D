<?php $__env->startSection('title', 'ცვლილება '); ?>
				...
				<div class="form-group">
					...
					<div class="col-xs-10">
						<select class="form-control" name="type" id="type">
							<option value="USER" <?php if($reason->type=='USER'): ?>selected <?php endif; ?>>მომხმარებელი</option>
							<option value="PROVIDER" <?php if($reason->type=='PROVIDER'): ?>selected <?php endif; ?>>მძღოლი</option>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-xs-10">
						<select class="form-control" name="status" id="status">
							<option value="1" <?php if($reason->status==1): ?>selected <?php endif; ?>>აქტიური</option>
							<option value="0" <?php if($reason->status==0): ?>selected <?php endif; ?>>არა აქტიური</option>
						</select>
					</div>
				</div>
