        ...
        <div class="card-body">
            <form class="form-horizontal" action="<?php echo e(route('admin.service.store')); ?>" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group row">
                    ...
                    <div class="col">
                        <span class="showcal"><i><b>ფასის კალკულაცია: <span id="changecal"></span></b></i></span>
                    </div>
                </div>
                
                <!-- Min Price -->
                <div class="form-group row">
                    <label for="min_price" class="bmd-label-floating"> მინიმალური საკომისიო (<?php echo e(currency()); ?>)</label>
                    <div class="col">
                    ...
                    <div class="col">
                        <span class="showcal"><i><b>TM (საკომისიო რომელიც დაემატება მოკლე მანძილზე მგზავრობას)</b></i></span>
                    </div>
                </div>
