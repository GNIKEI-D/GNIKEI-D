            ...
            <div class="col-lg-8 col-lg-offset-2 col-md-6 col-md-offset-3 col-md-8 col-md-offset-2">
                ...
                <div id="userform">
                    <ul class="nav nav-tabs nav-justified" role="tablist">
                        <li id="last-button" <?php if(!$errors->has('login_type')): ?> class="active" <?php endif; ?> <?php if($errors->has('login_type') && $errors->first('login_type') == 'admin'): ?>  class="active" <?php endif; ?>><a href="#signup" role="tab" data-toggle="tab">ადმინისტრატორი</a></li>
                        <li <?php if($errors->has('login_type') && $errors->first('login_type') == 'dispatcher'): ?>  class="active" <?php endif; ?>><a href="#dispatcher" role="tab" data-toggle="tab">დისპეჩერი</a></li>
                        <li <?php if($errors->has('login_type') && $errors->first('login_type') == 'account'): ?>  class="active" <?php endif; ?>><a href="#account" role="tab" data-toggle="tab">ანგარიშების მენეჯერი</a></li>
                        <li id="first-button" <?php if($errors->has('login_type') && $errors->first('login_type') == 'dispute'): ?>  class="active" <?php endif; ?>><a href="#dispute" role="tab" data-toggle="tab">საჩივრების მენეჯერი</a></li>
                    </ul>
                        ...
                        <div class="tab-pane fade <?php if(!$errors->has('login_type')): ?> active <?php endif; ?> <?php if($errors->has('login_type') && $errors->first('login_type') == 'admin'): ?> active <?php endif; ?> in" id="signup">
                            ...
                            <form id="signup" role="form" method="POST" action="<?php echo e(url('/admin/login')); ?>">
                                ...
                                <div class="mrgn-30-top">
                                    ...
                                    <button type="submit" class="btn btn-larger btn-block" /> ავტორიზაცია
                                    </button>
                                </div>
                            </form>
                            <div class="row">
