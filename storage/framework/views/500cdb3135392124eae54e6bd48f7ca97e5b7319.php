<?php $__env->startSection('title', 'Drivers Earnings '); ?>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header card-header-primary">
                <h4 class="card-title ">მიმოხილვა</h4>
            <h3>მძღოლის შემოსვალი</h3>
            </div>
            <div class="card-body">
            <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="box bg-white">
                            <div class="box-block clearfix">
                                <h5 class="float-xs-left"><?php echo app('translator')->getFromJson('admin.include.provider_earnings'); ?></h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($provider->status == "approved"): ?>
                                                <span class="tag tag-success">დადასტურებულია</span>
                                            <?php elseif($provider->status == "banned"): ?>
                                                <span class="tag tag-danger">დაბლოკილია</span>
                                            <?php elseif($provider->status == "document"): ?>
                                                <span class="tag tag-warning">ელოდება ვერიფიკაციას</span>
                                            <?php elseif($provider->status == "onboarding"): ?>
                                                <span class="tag tag-danger">დოკუმენტები აკლია</span>
                                            <?php else: ?>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('admin.statement', $provider->id)); ?>">შედეგები</a>
                                        </td>
                                    </tr>
