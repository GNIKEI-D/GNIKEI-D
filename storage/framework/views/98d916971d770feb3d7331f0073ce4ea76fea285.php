<?php $__env->startSection('title', 'პანელი '); ?>
            ...
            <div class="col-md-6">
                <form action="<?php echo e(url('confirm/ride')); ?>" method="GET" onkeypress="return disableEnterKey(event);">
                    <div class="input-group dash-form">
                        <input type="text" class="form-control" id="origin-input" name="s_address"  placehold="დაწყების მისამართი">
                    </div>

                    <div class="input-group dash-form">
                        <input type="text" class="form-control" id="destination-input" name="d_address"  placehold="დასრულების მისამართი" >
                    </div>
                    ...
                    <div class="input-group dash-form" id="hours" >
                        <input type="number" class="form-control" id="rental_hours" name="rental_hours"  placehold="(საათები)?" >
                    </div>
