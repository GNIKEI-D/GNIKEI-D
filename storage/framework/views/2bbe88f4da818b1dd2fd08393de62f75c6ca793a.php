<?php $__env->startSection('title', 'ფუნქც რუქა '); ?>
        ...
        <div class="card">
            <div class="card-header card-header-primary">
                ...
                <div class="float-xs-right">
                    <button class="btn btn-primary godseye_menu" data-value="ALL">ყველა</button>
                    <button class="btn btn-default godseye_menu" data-value="ACTIVE">აქტიური</button>
                    <button class="btn btn-default godseye_menu" data-value="STARTED">მივა მალე ასაყვანად</button>
                    <button class="btn btn-default godseye_menu" data-value="ARRIVED">მივიდა ასაყვანად</button>
                    <button class="btn btn-default godseye_menu" data-value="PICKEDUP">მგზავრობს</button>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
                <div class="col-md-4">
                    <h3 class="provider_title btn-primary">ყველა</h3>
