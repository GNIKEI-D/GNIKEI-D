...
                             <h5> SIGN UP <i class = "fa fa-chevron-right"> </i> </h5>
                ...
                <!-- <p class="note-or">Or <a href="<?php echo e(url('login')); ?>">sign in</a> with your rider account.</p> -->
            </div>
        </div>
    </div>
</div>
...
<div class="row white-section pad-60 no-margin">
    <div class="container">
        ...
        <div class = "col-md-4 content-block small">
            ...
                            <div class = "icon"> <img src = "<?php echo e(asset ('asset / img / driving-license.png')); ?>"> </div>
                        <h2> You own your time </h2>
                        <div class = "title-divider"> </div>
                        <p> You can drive with <?php echo e(config ('constants.site_title', 'TAXI3')); ?> anytime, day or night, 365 days a year. Travel does not interfere with your routine, you make your schedules, go offline at any time. </p>
                    </div>
                </div>
...
<div class="row gray-section no-margin full-section">
    <div class="container">                
        <div class="col-md-6 content-block">
            <div class = "icon"> <img src = "<?php echo e(asset ('asset / img / taxi-car.png')); ?>"> </div>
             <h3> About the app </h3>
...
             <a class="content-more more-btn" href="<?php echo e(url('login')); ?>"> DOWNLOAD THE APP AND START NOW <i class = "fa fa-chevron-right"> </i> </a>
        </div>
...
<div class="row white-section pad-60 no-margin">
    <div class="container">
        ...
        <div class="col-md-4 content-block small">
            ...
            <h2>Segurança</h2>
            <div class="title-divider"></div>
            <p>When you drive with <?php echo e(config ('constants.site_title', 'TAXI3')); ?>, you get 24/7 support. All runners are verified with their personal information and phone number. That way you will know who is traveling and so will we. </p>
        </div></div>
...
<a class="content-more more-btn" href="<?php echo e(url('login')); ?>">COMEÇE A DIRIGIR AGORA <i class="fa fa-chevron-right"></i></a>
