    ...
    <div class="full-page-bg-inner">
        <div class="row no-margin">
            <div class="col-md-6 log-left">
                ...
                <p>Bem-vindo(a) ao <?php echo e(config('constants.site_title','TAXI3')); ?>, a maneira mais fácil de se locomover com o toque de um botão.</p>
            </div>
...
<!--                            <div id="first_step">
                            ...
                            <div id="second_step">
                                ...
                                <div class="col-md-6">
                                    <input type="text" autofocus class="form-control" placehold="Nome" name="first_name" value="<?php echo e(old('first_name')); ?>" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="First Name can only contain alphanumeric characters and . - spaces">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" placehold="Sobrenome" name="last_name" value="<?php echo e(old('last_name')); ?>" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="Last Name can only contain alphanumeric characters and . - spaces">
                                ...
                                <div class="col-md-12">
                                    <input type="email" class="form-control" name="email" placehold="E-mail" value="<?php echo e(old('email')); ?>" data-validation="email">
                                ...
                                <div class="col-md-12">
                                    <input type="text" id="phone_number" class="form_tel" class="form-control" placehold="Número celular com DDD" name="phone_number" value="<?php echo e(old('phone_number')); ?>" data-stripe="number" maxlength="11" onkeypress="return isNumberKey(event);" required/>
                                </div>
