                    ...
                    <div class="col-xs-5">
                        <label class="radio-inline">
                            <input type="radio" name="status" value="A" class="radio"
                                <?php echo e(request()->has('status')&&request()->get('status')=="A"?" checked":""); ?>> აქტიური
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="status" value="P" class="radio"
                                <?php echo e(request()->has('status')&&request()->get('status')=="P"?" checked":""); ?>> ელოდებ დოკუმენტებს
                            
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="status" value="F" class="radio"
                                <?php echo e(request()->has('status')&&request()->get('status')=="F"?" checked":""); ?>> აკლია დოკუმენტები
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-success btn-block"
                                    href="<?php echo e(route('admin.provider.document.index', $provider->id )); ?>">ვერიფიცირებულია</a>
                                <?php else: ?>
                                <a class="btn btn-danger btn-block label-right"
                                    href="<?php echo e(route('admin.provider.document.index', $provider->id )); ?>">ყურადღება! <span
                            ...
                            <td>
                                ...
                                <label class="btn btn-block btn-primary">კი</label>
                                <?php else: ?>
                                <label class="btn btn-block btn-warning">არა</label>
                                <?php endif; ?>
                                <?php else: ?>
