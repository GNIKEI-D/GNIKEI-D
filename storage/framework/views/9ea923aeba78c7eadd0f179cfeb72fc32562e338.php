...
<div class="card">
  <div class="card-header card-header-primary">
    ...
    <div class="col-md-12" style="height:50px;color:red;">
                ** საცდელი რეჟიმი : <?php echo app('translator')->getFromJson('admin.demomode'); ?>
            </div>
            <?php endif; ?>
        <h5 class="card-title">
            <?php echo app('translator')->getFromJson('admin.dispatcher.dispatcher'); ?>
            <?php if(Setting::get('demo_mode', 0) == 1): ?>
            <span class="pull-right">(*საცდელ რეჟიმში დამალულია)</span>
            <?php endif; ?>
        </h5>
  </div>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('dispatcher-providers')): ?>
            <a href="<?php echo e(route('admin.dispatch-manager.create')); ?>" style="margin-left: 1em;" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> <?php echo app('translator')->getFromJson('admin.dispatcher.add_new_dispatcher'); ?></a>
            <?php endif; ?>
            <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="<?php echo e(route('admin.dispatch-manager.destroy', $dispatcher->id)); ?>" method="POST">
                                ...
                                <a href="<?php echo e(route('admin.dispatch-manager.edit', $dispatcher->id)); ?>" class="btn btn-info"><i class="fa fa-pencil"></i> <?php echo app('translator')->getFromJson('admin.edit'); ?></a>
                                <button class="btn btn-danger" onclick="return confirm('დარწმუნებული ხარ?')"><i class="fa fa-trash"></i> <?php echo app('translator')->getFromJson('admin.delete'); ?></button>
                            </form>
                        </td>
                    </tr>
