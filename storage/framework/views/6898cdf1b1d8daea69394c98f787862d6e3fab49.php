    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title">რუქის ნახვა</h4>
            </div>
            <div class="card-body">
                
                    <div id="map"></div>
                    <div id="legend"><h3>შენიშვნა: </h3></div>
...
<script>
    ...
    function initMap() {
        ...
        div.innerHTML = '<img src="' + mapIcons['user'] + '"> ' + 'მომხმარებელი';
        legend.appendChild(div);

        var div = document.createElement('div');
        div.innerHTML = '<img src="' + mapIcons['offline'] + '"> ' + 'მძღოლი გასულია';
        legend.appendChild(div);
        
        var div = document.createElement('div');
        div.innerHTML = '<img src="' + mapIcons['active'] + '"> ' + 'აქტიური მძღოლი';
        legend.appendChild(div);
        
        var div = document.createElement('div');
        div.innerHTML = '<img src="' + mapIcons['unactivated'] + '"> ' + 'არა აქტიური მძღოლი';
        legend.appendChild(div);
