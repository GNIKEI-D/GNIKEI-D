<?php $__env->startSection('title', 'დოკუმენტები '); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header card-header-primary">
                ...
                <h5>მძღოლი: <b><?php echo e($Provider->first_name); ?> <?php echo e($Provider->last_name); ?></b> </h5>
                ...
                <a style="margin-left: 1em;margin-top: -30px" class="btn btn-success pull-right"
                    href="<?php echo e(route('admin.provider.approve', $Provider->id )); ?>"><i class="fa fa-check"></i> გააქტიურე
                    მძღოლი</a>
                <?php endif; ?>
                <?php endif; ?>
            ...
            <div class="card-body">
                ...
                <?php if($ProviderService->count() >= 1): ?>
                    ...
                    <h3 class="card-title">განაახლე სერვისი</h3>
                ...
                <form action="<?php echo e(route('admin.provider.document.store', $Provider->id)); ?>" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="from-group">
                            <label for="service_type" class="bmd-label-floating">სერვისის ტიპი</label>
                        ...
                        <div class="form-group">
                            <label for="service_number" class="bmd-label-floating">ავტ ნომერი</label>
                                <input class="form-control" type="text" value="" name="service_number" required id="service_number">
                            </div>
                        </div>
                        <div class="col-md-3">
                        <div class="form-group">
                            <label for="service_model" class="bmd-label-floating">ავტ მოდელი</label>
                        ...
                        <div class="form-group">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('provider-service-update')): ?><button class="btn btn-primary btn-block"
                                type="submit">განახლება</button><?php endif; ?>
                        </div>
                        </div>
                    </div>
                    <?php endif; ?>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('provider-service-update')): ?><button class="btn btn-success"
                                    type="submit">დამატება</button><?php endif; ?>
                            </div>
                            </div>
                        </div>
                        <?php endif; ?>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php if($Document->status == "ACTIVE"): ?><?php echo e("APPROVED"); ?><?php else: ?> <?php echo e(" ელოდება დასტურს"); ?>
