...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?><?php echo e(config('constants.site_title', 'TAXI3')); ?></title>
            ...
            <div class="full-page-bg-inner">
                <div class="row no-margin">
                    <div class="col-md-6 log-left">
                        ...
                        <h2><?php echo e(config('constants.site_title','TAXI3')); ?> You need partners like you.</h2>
                        <p>Drive with the <?php echo e(config('constants.site_title','TAXI3')); ?> and earn a lot of money with independent contractor. Get paid weekly just to help our rider community take city tours. Be your own boss and get paid on fares for driving at your own time.</p>
                    </div>
