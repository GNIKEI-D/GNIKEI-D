<?php $__env->startSection('title', 'შეტყობინებები '); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="<?php echo e(route('admin.notification.destroy', $notify->id)); ?>" method="POST">
                                    ...
                                    <a href="<?php echo e(route('admin.notification.edit', $notify->id)); ?>" class="btn btn-info"><i class="fa fa-pencil"></i> ცვლილება</a>
                                    <?php endif; ?>
