                        ...
                        <ul class="nav nav-tabs" data-tabs="tabs">
                            <li class="nav-item">
                                <a class="nav-link active" id="general-tab" data-toggle="tab" href="#general" role="tab"
                                    aria-controls="general" aria-expanded="true">მთავარი</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " id="social-tab" data-toggle="tab" href="#social" role="tab"
                                    aria-controls="social" aria-expanded="false">ლინკები</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <div class="col-md-9">
                                <form class="form-horizontal" action="<?php echo e(route('admin.settings.store')); ?>" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <select class="form-control" id="timezone" name="timezone"
                                                ...
                                                <option value="America/Havana" <?php if(Config::get('constants.timezone')=='America/Havana'
                                                    ): ?> selected <?php endif; ?>>(GMT-05:00) Cuba</option>
                                                <option value="America/Bogota" <?php if(Config::get('constants.timezone')=='America/Bogota'
                                                    ): ?> selected <?php endif; ?>>(GMT-05:00) Bogota, Lima, Quito, Rio Branco
                                                </option>
                                                <option value="America/Caracas"
                                                    <?php if(Config::get('constants.timezone')=='America/Caracas' ): ?> selected <?php endif; ?>>
                                                    (GMT-04:30) Caracas</option>
                                                <option value="America/Santiago"
                                                    <?php if(Config::get('constants.timezone')=='America/Santiago' ): ?> selected <?php endif; ?>>
                                                ...
                                                <option value="Atlantic/Stanley"
                                                    <?php if(Config::get('constants.timezone')=='Atlantic/Stanley' ): ?> selected <?php endif; ?>>
                                                    (GMT-04:00) Faukland Islands</option>
                                                <option value="America/Campo_Grande"
                                                    <?php if(Config::get('constants.timezone')=='America/Campo_Grande' ): ?> selected <?php endif; ?>>
                                                    (GMT-04:00) Brazil</option>
                                                <option value="America/Goose_Bay"
                                                    <?php if(Config::get('constants.timezone')=='America/Goose_Bay' ): ?> selected <?php endif; ?>>
                                                    (GMT-04:00) Atlantic Time (Goose Bay)</option>
                                                <option value="America/Glace_Bay"
                                                    <?php if(Config::get('constants.timezone')=='America/Glace_Bay' ): ?> selected <?php endif; ?>>
                                                    (GMT-04:00) Atlantic Time (Canada)</option>
                                                <option value="America/St_Johns"
                                                    <?php if(Config::get('constants.timezone')=='America/St_Johns' ): ?> selected <?php endif; ?>>
                                                    (GMT-03:30) Newfoundland</option>
                                                <option value="America/Araguaina"
                                                    <?php if(Config::get('constants.timezone')=='America/Araguaina' ): ?> selected <?php endif; ?>>
                                                    (GMT-03:00) UTC-3</option>
                                                <option value="America/Montevideo"
                                                    <?php if(Config::get('constants.timezone')=='America/Montevideo' ): ?> selected <?php endif; ?>>
                                                    (GMT-03:00) Montevideo</option>
                                                <option value="America/Miquelon"
                                                    <?php if(Config::get('constants.timezone')=='America/Miquelon' ): ?> selected <?php endif; ?>>
                                                    (GMT-03:00) Miquelon, St. Pierre</option>
                                                <option value="America/Godthab"
                                                    <?php if(Config::get('constants.timezone')=='America/Godthab' ): ?> selected <?php endif; ?>>
                                                    (GMT-03:00) Greenland</option>
                                                <option value="America/Argentina/Buenos_Aires"
                                                    <?php if(Config::get('constants.timezone')=='America/Argentina/Buenos_Aires' ): ?> selected <?php endif; ?>>
                                                    (GMT-03:00) Buenos Aires</option>
                                                <option value="America/Sao_Paulo"
                                                    <?php if(Config::get('constants.timezone')=='America/Sao_Paulo' ): ?> selected <?php endif; ?>>
                                                    (GMT-03:00) Brasilia</option>
                                                <option value="America/Noronha"
                                                    <?php if(Config::get('constants.timezone')=='America/Noronha' ): ?> selected <?php endif; ?>>
                                                    (GMT-02:00) Mid-Atlantic</option>
                                                <option value="Atlantic/Cape_Verde"
                                                    <?php if(Config::get('constants.timezone')=='Atlantic/Cape_Verde' ): ?> selected <?php endif; ?>>
                                                    (GMT-01:00) Cape Verde Is.</option>
                                                <option value="Atlantic/Azores"
                                                    <?php if(Config::get('constants.timezone')=='Atlantic/Azores' ): ?> selected <?php endif; ?>>
                                                    (GMT-01:00) Azores</option>
                                                <option value="Europe/Belfast" <?php if(Config::get('constants.timezone')=='Europe/Belfast'
                                                    ): ?> selected <?php endif; ?>>(GMT) Greenwich Mean Time : Belfast</option>
                                                <option value="Europe/Dublin" <?php if(Config::get('constants.timezone')=='Europe/Dublin'
                                                    ): ?> selected <?php endif; ?>>(GMT) Greenwich Mean Time : Dublin</option>
                                                <option value="Europe/Lisbon" <?php if(Config::get('constants.timezone')=='Europe/Lisbon'
                                                    ): ?> selected <?php endif; ?>>(GMT) Greenwich Mean Time : Lisbon</option>
                                                <option value="Europe/London" <?php if(Config::get('constants.timezone')=='Europe/London'
                                                    ): ?> selected <?php endif; ?>>(GMT) Greenwich Mean Time : London</option>
                                                <option value="Africa/Abidjan" <?php if(Config::get('constants.timezone')=='Africa/Abidjan'
                                                    ): ?> selected <?php endif; ?>>(GMT) Monrovia, Reykjavik</option>
                                                <option value="Europe/Amsterdam"
                                                    <?php if(Config::get('constants.timezone')=='Europe/Amsterdam' ): ?> selected <?php endif; ?>>
                                                    (GMT+01:00) Amsterdam, Berlin, Bern, Rome, Stockholm, Vienna
                                                </option>
                                                <option value="Europe/Belgrade"
                                                    <?php if(Config::get('constants.timezone')=='Europe/Belgrade' ): ?> selected <?php endif; ?>>
                                                    (GMT+01:00) Belgrade, Bratislava, Budapest, Ljubljana, Prague
                                                </option>
                                                <option value="Europe/Brussels"
                                                    <?php if(Config::get('constants.timezone')=='Europe/Brussels' ): ?> selected <?php endif; ?>>
                                                    (GMT+01:00) Brussels, Copenhagen, Madrid, Paris</option>
                                                <option value="Africa/Algiers" <?php if(Config::get('constants.timezone')=='Africa/Algiers'
                                                    ): ?> selected <?php endif; ?>>(GMT+01:00) West Central Africa</option>
                                                <option value="Africa/Windhoek"
                                                    <?php if(Config::get('constants.timezone')=='Africa/Windhoek' ): ?> selected <?php endif; ?>>
                                                    (GMT+01:00) Windhoek</option>
                                                <option value="Asia/Beirut" <?php if(Config::get('constants.timezone')=='Asia/Beirut' ): ?>
                                                    selected <?php endif; ?>>(GMT+02:00) Beirut</option>
                                                <option value="Africa/Cairo" <?php if(Config::get('constants.timezone')=='Africa/Cairo' ): ?>
                                                    selected <?php endif; ?>>(GMT+02:00) Cairo</option>
                                                <option value="Asia/Gaza" <?php if(Config::get('constants.timezone')=='Asia/Gaza' ): ?>
                                                    selected <?php endif; ?>>(GMT+02:00) Gaza</option>
                                                <option value="Africa/Blantyre"
                                                    <?php if(Config::get('constants.timezone')=='Africa/Blantyre' ): ?> selected <?php endif; ?>>
                                                    (GMT+02:00) Harare, Pretoria</option>
                                                <option value="Asia/Jerusalem" <?php if(Config::get('constants.timezone')=='Asia/Jerusalem'
                                                    ): ?> selected <?php endif; ?>>(GMT+02:00) Jerusalem</option>
                                                <option value="Europe/Minsk" <?php if(Config::get('constants.timezone')=='Europe/Minsk' ): ?>
                                                    selected <?php endif; ?>>(GMT+02:00) Minsk</option>
                                                <option value="Asia/Damascus" <?php if(Config::get('constants.timezone')=='Asia/Damascus'
                                                    ): ?> selected <?php endif; ?>>(GMT+02:00) Syria</option>
                                                <option value="Europe/Moscow" <?php if(Config::get('constants.timezone')=='Europe/Moscow'
                                                    ): ?> selected <?php endif; ?>>(GMT+03:00) Moscow, St. Petersburg, Volgograd
                                                </option>
                                                <option value="Africa/Addis_Ababa"
                                                    <?php if(Config::get('constants.timezone')=='Africa/Addis_Ababa' ): ?> selected <?php endif; ?>>
                                                    (GMT+03:00) Nairobi</option>
                                                <option value="Asia/Tehran" <?php if(Config::get('constants.timezone')=='Asia/Tehran' ): ?>
                                                    selected <?php endif; ?>>(GMT+03:30) Tehran</option>
                                                <option value="Asia/Dubai" <?php if(Config::get('constants.timezone')=='Asia/Dubai' ): ?>
                                                    selected <?php endif; ?>>(GMT+04:00) Abu Dhabi, Muscat</option>
                                                <option value="Asia/Yerevan" <?php if(Config::get('constants.timezone')=='Asia/Yerevan' ): ?>
                                                    selected <?php endif; ?>>(GMT+04:00) Yerevan</option>
                                                <option value="Asia/Kabul" <?php if(Config::get('constants.timezone')=='Asia/Kabul' ): ?>
                                                    selected <?php endif; ?>>(GMT+04:30) Kabul</option>
                                                <option value="Asia/Yekaterinburg"
                                                    <?php if(Config::get('constants.timezone')=='Asia/Yekaterinburg' ): ?> selected <?php endif; ?>>
                                                    (GMT+05:00) Ekaterinburg</option>
                                                <option value="Asia/Tashkent" <?php if(Config::get('constants.timezone')=='Asia/Tashkent'
                                                    ): ?> selected <?php endif; ?>>(GMT+05:00) Tashkent</option>
                                                <option value="Asia/Kolkata" <?php if(Config::get('constants.timezone')=='Asia/Kolkata' ): ?>
                                                    selected <?php endif; ?>>(GMT+05:30) Chennai, Kolkata, Mumbai, New Delhi
                                                </option>
                                                <option value="Asia/Katmandu" <?php if(Config::get('constants.timezone')=='Asia/Katmandu'
                                                    ): ?> selected <?php endif; ?>>(GMT+05:45) Kathmandu</option>
                                                <option value="Asia/Dhaka" <?php if(Config::get('constants.timezone')=='Asia/Dhaka' ): ?>
                                                    selected <?php endif; ?>>(GMT+06:00) Astana, Dhaka</option>
                                                <option value="Asia/Novosibirsk"
                                                    <?php if(Config::get('constants.timezone')=='Asia/Novosibirsk' ): ?> selected <?php endif; ?>>
                                                    (GMT+06:00) Novosibirsk</option>
                                                <option value="Asia/Rangoon" <?php if(Config::get('constants.timezone')=='Asia/Rangoon' ): ?>
                                                    selected <?php endif; ?>>(GMT+06:30) Yangon (Rangoon)</option>
                                                <option value="Asia/Bangkok" <?php if(Config::get('constants.timezone')=='Asia/Bangkok' ): ?>
                                                    selected <?php endif; ?>>(GMT+07:00) Bangkok, Hanoi, Jakarta</option>
                                                <option value="Asia/Krasnoyarsk"
                                                    <?php if(Config::get('constants.timezone')=='Asia/Krasnoyarsk' ): ?> selected <?php endif; ?>>
                                                    (GMT+07:00) Krasnoyarsk</option>
                                                <option value="Asia/Hong_Kong" <?php if(Config::get('constants.timezone')=='Asia/Hong_Kong'
                                                    ): ?> selected <?php endif; ?>>(GMT+08:00) Beijing, Chongqing, Hong Kong, Urumqi
                                                </option>
                                                <option value="Asia/Irkutsk" <?php if(Config::get('constants.timezone')=='Asia/Irkutsk' ): ?>
                                                    selected <?php endif; ?>>(GMT+08:00) Irkutsk, Ulaan Bataar</option>
                                                <option value="Australia/Perth"
                                                    <?php if(Config::get('constants.timezone')=='Australia/Perth' ): ?> selected <?php endif; ?>>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <input class="form-control" type="text"
                                                value="<?php echo e(config('constants.site_copyright', '&copy; '.date('Y').' TAXI3')); ?>"
                        ...
                        <div class=" row">
                            <div class="col-md-8">
                                <form class="form-horizontal" action="<?php echo e(route('admin.settings.store')); ?>" method="POST"
                                    ...
                                    <div class="form-group">
                                        <label for="store_link_ios" class="col-xs-3 bmd-label-floating">Andorid App ვერსია მგზავრ</label>
                                        <div class="col-xs-9">
                                            <input class="form-control" type="text"
                                    ...
                                    <div class="form-group">
                                        <label for="store_link_ios" class="col-xs-3 bmd-label-floating">Andorid App ვერსია მძღოლ</label>
                                        <div class="col-xs-9">
                                            <input class="form-control" type="text"
                                    ...
                                    <div class="form-group">
                                        <label for="store_link_ios" class="col-xs-3 bmd-label-floating">IOS App ვერსია მგზავრ</label>
                                        <div class="col-xs-9">
                                            <input class="form-control" type="text"
                                    ...
                                    <div class="form-group">
                                        <label for="store_link_ios" class="col-xs-3 bmd-label-floating">IOS App ვერსია მძღოლ</label>
                                        <div class="col-xs-9">
                                            <input class="form-control" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <input class="form-control" type="number"
                                                ...
                                                placehold="მძღოლის ძებნის რადიუსი კმ">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <select name="environment" required id="environment" class="form-control">
                                                <option value="development">განახლება</option>
                                                <option value="production">აქტიური</option>
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <div class=" row">
                            <div class="col-md-10">
                                <form class="form-horizontal" action="<?php echo e(route('admin.settings.store')); ?>" method="POST"
                                    ...
                                    <div class="form-group">
                                        <label for="stripe_secret_key" class="col-xs-3 bmd-label-floating">ვერიფიკაცია OTP</label>
                                        <div class="col-xs-9">
                                    ...
                                    <div class="form-group">
                                        <label for="stripe_secret_key" class="col-xs-3 bmd-label-floating">ვერიფიკაცია ფას</label>
                                        <div class="col-xs-9">
