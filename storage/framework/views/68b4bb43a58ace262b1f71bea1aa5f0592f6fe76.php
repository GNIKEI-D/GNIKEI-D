<?php $__env->startSection('title', 'გაუქმების მიზეზი'); ?>
                ...
                <table class="table">
                    ...
                    <?php $__currentLoopData = $reasons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $reason): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($reason->type == "PROVIDER" ? "მძღოლი" : "მომხმარებელი"); ?></td>
                            ...
                            <td>
                                <form action="<?php echo e(route('admin.reason.destroy', $reason->id)); ?>" method="POST">
                                    ...
                                    <a href="<?php echo e(route('admin.reason.edit', $reason->id)); ?>" class="btn btn-info"><i class="fa fa-pencil"></i> ცვლილება</a>
                                    <?php endif; ?>
